...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    kP = RobotContainer.prefs.getNumber("Shooter kP",0.0465);
    kI = RobotContainer.prefs.getNumber("Shooter kI",0.0005);
    kD = RobotContainer.prefs.getNumber("Shooter kD",0.0);
    kF = RobotContainer.prefs.getNumber("Shooter kF",0.048);
    iZone = (int) RobotContainer.prefs.getNumber("Shooter I-Zone", 150);

    AkP = RobotContainer.prefs.getNumber("Accelerator kP",0.045);
    AkI = RobotContainer.prefs.getNumber("Accelerator kI",0.0005);
    AkD = RobotContainer.prefs.getNumber("Accelerator kD",0.0);
    AkF = RobotContainer.prefs.getNumber("Accelerator kF",0.05);
    AiZone = (int) RobotContainer.prefs.getNumber("Accelerator I-Zone", 150);
  ...
  public void dashboardVelocity(){
    ...
    double wheelRPM = RobotContainer.prefs.getNumber("Shooter Setpoint",5000);
    double AwheelRPM = RobotContainer.prefs.getNumber("Accelerator Setpoint",5000);
